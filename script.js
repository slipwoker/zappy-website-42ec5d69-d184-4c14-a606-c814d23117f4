    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "דן טיפולים ועיסויים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '42ec5d69-d184-4c14-a606-c814d23117f4',
                    name: data.name || '',
                    email: data.email || '',
